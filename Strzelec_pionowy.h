...
/**
	Dziedziczy po klasie Postac. Jeœli zostanie stworzony obiekt klasy Strzelec_pionowy, to bêd¹ wykonywane zdefiniowane tutaj ruchy i œmieræ.
*/
...
public:
	...
	/// <summary>
	/// Œmieræ Strzelca pionowego, usuniêcie z planszy zajmowanych pól oraz strza³u znajduj¹cego siê w locie.
	/// </summary>
	/// <param name="tabela">jako referencja przekazywana jest ca³a tabela</param>
